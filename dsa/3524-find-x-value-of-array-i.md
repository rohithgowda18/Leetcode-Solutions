...
Return an array `result` of size `k` where `result[x]` is the **x-value** of `nums` for `0 subarray that starts from the beginning of the array and extends to any point within it.
